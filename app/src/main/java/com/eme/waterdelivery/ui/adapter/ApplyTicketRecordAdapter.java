 ...
 */
public class ApplyTicketRecordAdapter extends BaseQuickAdapter<SaleTicketRecordBo.ListBean, BaseViewHolder> {

    private LayoutInflater inflater;

    public ApplyTicketRecordAdapter(Context context, List<SaleTicketRecordBo.ListBean>data) {
    ...
    protected void convert(BaseViewHolder helper, SaleTicketRecordBo.ListBean item) {
        ...
        helper.setText(R.id.tv_amount,TextUtils.concat("发票抬头: ",item.getInvoiceTitle()));
    }
}
