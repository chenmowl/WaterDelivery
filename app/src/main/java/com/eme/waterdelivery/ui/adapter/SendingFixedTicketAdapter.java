 ...
 */
public class SendingFixedTicketAdapter extends BaseQuickAdapter<OrderDetailBo.GoodsBean, BaseViewHolder> {


    public SendingFixedTicketAdapter(List<OrderDetailBo.GoodsBean> data) {
