 ...
 */
public class DelayFragPresenter implements DelayFragContract.Presenter {

    private static final String TAG = DelayFragPresenter.class.getSimpleName();

    private DelayFragContract.View view;
    ...
    @Inject
    public DelayFragPresenter(BaseView view, RetrofitHelper retrofitHelper) {
        this.view = (DelayFragContract.View) view;
