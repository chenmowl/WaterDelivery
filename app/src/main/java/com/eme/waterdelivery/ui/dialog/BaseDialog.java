...
public abstract class BaseDialog {
     ...
     * Dialog样式
     */
    private int mStyle = R.style.KDialogTheme;
     ...
     * @param
     */
    public void showDialog(Context context, ViewGroup viewGroup) {
        // 如果Dialog没有创建，则先创建Dialog
        if (null == mDialog) {

            // 创建Dialog并设置上下文和样式
            mDialog = new Dialog(context, getStyle());
            ...
            // 设置Dialog的View
            mDialog.setContentView(createView(context,viewGroup));
