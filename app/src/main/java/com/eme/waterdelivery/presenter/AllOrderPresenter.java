...
public class AllOrderPresenter implements AllOrderContract.Presenter {
    ...
    private static final String TAG=AllOrderPresenter.class.getSimpleName();
    ...
    @Inject
    public AllOrderPresenter(BaseView view, RetrofitHelper retrofitHelper) {
        this.view = (AllOrderContract.View)view;
    ...
    public void requestData(final int refreshFlag) {
        ...
        disposables.add(Observable.zip(retrofitHelper.getHistoryOrders(storeId, pNum, Constant.PAGE_SIZE,Constant.ORDER_ALL), retrofitHelper.getHistoryOrderSum(storeId), new BiFunction<Result<HistoryOrderVo>, Result<HistoryOrderSumBo>, HistoryOrderZip>() {
            @Override
