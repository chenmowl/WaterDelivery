 ...
 */
public class AssessMoneyAdapter extends BaseQuickAdapter<AssessMoneyVo.DayStatementsBean, BaseViewHolder> {

    public AssessMoneyAdapter(List<AssessMoneyVo.DayStatementsBean> data) {
        super(R.layout.item_assess_money, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, AssessMoneyVo.DayStatementsBean item) {
