 ...
 */
public class SaleTicketRecordPresenter implements SaleTicketRecordContract.Presenter {

    private static final String TAG = SaleTicketRecordPresenter.class.getSimpleName();

    private SaleTicketRecordContract.View view;
    ...
    @Inject
    public SaleTicketRecordPresenter(BaseView view, RetrofitHelper retrofitHelper) {
        this.view = (SaleTicketRecordContract.View) view;
