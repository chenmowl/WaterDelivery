 ...
 */
public class GoodsSignPresenter implements GoodsSignContract.Presenter {

    private static final String TAG = GoodsSignPresenter.class.getSimpleName();
    ...
    @Inject
    public GoodsSignPresenter(BaseView view, RetrofitHelper retrofitHelper) {
        this.view = (GoodsSignContract.View) view;
