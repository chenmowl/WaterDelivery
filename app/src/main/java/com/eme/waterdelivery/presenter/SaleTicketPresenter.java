 ...
 */
public class SaleTicketPresenter implements SaleTicketContract.Presenter {

    private static final String TAG = SaleTicketPresenter.class.getSimpleName();

    private SaleTicketContract.View view;
    ...
    @Inject
    public SaleTicketPresenter(BaseView view, RetrofitHelper retrofitHelper) {
        this.view = (SaleTicketContract.View) view;
    ...
    @Override
    public void sellTicketSubmit(String memberName, String memberPhone, String memberAddress, String invoiceTitle, String ticketsModel, String payType, String memberAdressId, String tickets) {
        disposables.add(
                retrofitHelper.sellTicketSubmit(storeId,memberName,memberPhone,memberAddress,invoiceTitle,ticketsModel,payType,memberAdressId,tickets)
                .subscribeOn(Schedulers.io())
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    public void accept(Disposable disposable) throws Exception {
