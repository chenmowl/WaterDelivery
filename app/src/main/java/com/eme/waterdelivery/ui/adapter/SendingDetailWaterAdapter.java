 ...
 */
public class SendingDetailWaterAdapter extends BaseQuickAdapter<OrderDetailBo.GoodsBean, BaseViewHolder> {


    public SendingDetailWaterAdapter(List<OrderDetailBo.GoodsBean> data) {
        super(R.layout.item_sending_detail_water, data);
    }
    ...
    protected void convert(BaseViewHolder helper, OrderDetailBo.GoodsBean item) {
        ...
        helper.setText(R.id.tv_good_count, "x"+item.getGoodsNum());
