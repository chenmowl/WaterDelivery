...
public class SendingInstantPresenter implements SendingInstantContract.Presenter {

    private static final String TAG = SendingInstantPresenter.class.getSimpleName();

    private SendingInstantContract.View view;
    ...
    @Inject
    public SendingInstantPresenter(BaseView view, RetrofitHelper retrofitHelper) {
        this.view = (SendingInstantContract.View) view;
